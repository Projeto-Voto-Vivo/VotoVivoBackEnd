...
CONTAINER="votovivo_tema_check"
PORT="${TEMA_CHECK_PORT:-3396}"
...
echo "==> Verificando o alinhamento por tema..."
DATABASE_URL="$DB_URL" npx tsx scripts/verifica-alinhamento-tema.ts
